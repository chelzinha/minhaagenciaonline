...
// ============================================================
// ATENDE - REGRA DE LOCAL PADRAO POR ATENDENTE
//
// Mantem a arquitetura existente e acrescenta somente a terceira
// camada de fallback do LOCAL:
//   override manual > remetente > atendente > vazio
//
// O wrapper tambem amplia o cadastro administrativo de atendentes
// para persistir local_padrao sem alterar o RAW dos Correios.
// ============================================================
