...
| painelCliente | frontend/app/js/screens/painel.js | apps-script/etiquetas/14B_RASTRO_SERVICE.js: action_painelCliente_ | dias: 30, 60, 90 ou 0 | linhas do historico do cliente com situacao, previsao e ultima atualizacao | Alto: historico e rastreios | Alto: deve manter isolamento por sessao e cache |
