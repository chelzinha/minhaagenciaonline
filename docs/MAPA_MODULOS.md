...
| cadastros | `/cadastros` | `frontend/cadastros` | `cloudflare/cadastros-api` + D1 próprio | Preview do front; Worker e cron ativos; importação em conferência | `docs/modulos/cadastros/README.md` |
