...
| cadastros | `/cadastros` | `frontend/cadastros` | `cloudflare/cadastros-api` + D1 próprio | Preview do front; Worker sem endereço público e cron; D1 vazio | `docs/modulos/cadastros/README.md` |
