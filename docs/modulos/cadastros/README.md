...
3. Conferir autorização administrativa e um fluxo de associação na tela; a comparação de oito amostras da origem e o total da primeira passagem já foram realizados. Não há aliases manuais cadastrados para os três portais compartilhados, então essas identidades seguem pendentes para revisão humana.
