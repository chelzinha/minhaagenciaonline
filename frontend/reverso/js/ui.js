...
export const UI = {
  showLoading(text='Aguarde um instante...'){ const el=loadingEl(); if(!el) return; loadingTextEl().textContent=text; el.classList.add('show'); el.setAttribute('aria-hidden','false'); },
