function centralAgfAutoConfigurar() {
  ...
  const processingId = centralAgfFindUniqueFileIdByName_(CENTRAL_AGF_CFG.FILE_NAMES.PROCESSING);
  ...
  props.setProperties({
    ...
    [CENTRAL_AGF_CFG.PROPS.PROCESSING_SPREADSHEET_ID]: processingId
  }, false);
...
function centralAgfStatusConfiguracao() {
  ...
  return {
    ...
    processingConfigured: Boolean(props[CENTRAL_AGF_CFG.PROPS.PROCESSING_SPREADSHEET_ID])
  };
}
